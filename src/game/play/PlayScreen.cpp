...
namespace game
{
    namespace play
    {
        PlayScreen::PlayScreen(MineDigger& game)
            : m_game(game), m_config(game.getConfig().playScreenConfig), m_gemBoardView(*this)
        {
        ...
        void PlayScreen::onGameScreenStart(sys::AudioMixer& mixer)
        {
            ...
            m_sparkSprite.setTexture(m_pSparkTex, m_config.uSparkAnimSubImagesCount,
                                     m_config.uSparkAnimSubImagesStride);
